...
class ConnectionMock:
    '''Contains the same methods as the Connection class, used for mocking a connection'''
    ...
    def connect(self):
        self.group.conns[self.name] = self

    def read(self):
        while self.group.running: pass
    ...
    def queue_message(self, msg):
        self.group.q.put((self.name, AttrDict(msg)))
